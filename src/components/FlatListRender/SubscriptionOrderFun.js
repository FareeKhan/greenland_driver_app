...
const SubscriptionOrderFun = (props) => {
   const { item, onPress, orderStatus } = props;
      ...
      <TouchableOpacity onPress={() => onPress()} style={SubscriptionOrdersStyles.onGoingBox}>
         <View style={SubscriptionOrdersStyles.centerstatusBox}>
            <View style={SubscriptionOrdersStyles.statusBox}>
               <Text style={[SubscriptionOrdersStyles.pickFoodText]}>{orderStatus}</Text>
            </View>
         </View>
         <Spacing space={SH(10)} />
...
export default SubscriptionOrderFun