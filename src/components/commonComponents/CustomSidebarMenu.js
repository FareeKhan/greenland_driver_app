  ...
  return (
    <ScrollView>
      <View style={Sidemenu.customslidebarmenu}>
        ...
        <TouchableOpacity style={Sidemenu.flexrowset} onPress={
          () => Onpressfunction(RouteName.EARNINGS_TAB)
        }>
          <VectorIcon
            name="payments"
            icon="MaterialIcons"
            ...
            color={Colors.theme_background}
          />
          <Text style={Sidemenu.hometextstyle}>{t("Earnings_Label")}</Text>
        </TouchableOpacity>
        <TouchableOpacity style={Sidemenu.flexrowset} onPress={
          () => Onpressfunction(RouteName.NOTIFICATION_TAB)
        }>
          <VectorIcon
            name="notifications"
            icon="Ionicons"
        ...
        <TouchableOpacity style={Sidemenu.flexrowset} onPress={
          () => Onpressfunction(RouteName.SUBSCRIPTION_ORDERS)
        }>
          <VectorIcon icon="Feather" name="check-square" style={Sidemenu.logoimage} color={Colors.theme_background} size={SF(20)} />
          <Text style={Sidemenu.hometextstyle}>{t("Subscription_Order_Label")}</Text>
        </TouchableOpacity>
        <TouchableOpacity style={Sidemenu.flexrowset} onPress={
