...
import { Button, Spacing, Input, VectorIcon, PasswordInput, Container, ConfirmationAlert } from '../../components';
...
const EditProfile = (props) => {
   ...
   return (
      <Container backgroundColor={Colors.white_text_color}>
         <ScrollView>
         ...
         <ConfirmationAlert
            ...
            buttonminview={ProfileTabStyle.ButtonView}
            iconVisible={true}
            buttonText={t("Ok")}
         />
         <View style={ProfileTabStyle.BtnBox}>
            <Button title={t("Update_Label")} onPress={() => {
